...
2. If the design direction is still open, shortlist bundled styles with `slides-grab list-styles`, optionally preview with `slides-grab preview-styles`, and agree on a direction with the user. If none of the 35 bundled styles fit, design a fully custom visual direction.
